...
type ServerInterface interface {
	// list of foodposts
	// (GET /foodpost)
	ListFoodPosts(c *gin.Context, params model.ListFoodPostsParams)
	// create food post
	// (POST /foodpost)
	CreateFoodPost(c *gin.Context, params model.CreateFoodPostParams)
}
...
func (siw *ServerInterfaceWrapper) ListFoodPosts(c *gin.Context) {
	...
	c.Set(model.BasicAuthScopes, []string{""})

	// Parameter object where we will unmarshal all parameters from the context
	var params model.ListFoodPostsParams
...
func (siw *ServerInterfaceWrapper) CreateFoodPost(c *gin.Context) {
	...
	// Parameter object where we will unmarshal all parameters from the context
	var params model.CreateFoodPostParams
