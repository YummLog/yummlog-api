...
const (
	Dislike  FoodItemsExperience = "dislike"
	Favorite FoodItemsExperience = "favorite"
	Like     FoodItemsExperience = "like"
)
...
type FoodItems struct {
	// Experience like, dislike or loved it
...
// FoodItemsExperience like, dislike or loved it
...
type ListFoodPostsParams struct {
	RestaurantName *string `form:"restaurantName,omitempty" json:"restaurantName,omitempty"`
}

// CreateFoodPostJSONRequestBody defines body for CreateFoodPost for application/json ContentType.
type CreateFoodPostJSONRequestBody = FoodPost
